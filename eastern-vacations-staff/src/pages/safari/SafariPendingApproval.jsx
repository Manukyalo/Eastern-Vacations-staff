    ...
    <div className="min-h-screen bg-primary-dark flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-md text-center">
        ...
        <div className="relative w-24 h-24 mx-auto mb-8">
          <div className="absolute inset-0 bg-accent-green/10 rounded-full animate-pulse blur-xl" />
          <div className="relative w-full h-full bg-surface border border-accent-green/20 rounded-[2rem] flex items-center justify-center">
            <Clock size={40} className="text-accent-green animate-[spin_4s_linear_infinite]" />
          </div>
        </div>

        <h2 className="text-3xl font-heading font-black text-white mb-4 uppercase tracking-tight">
          Expedition <span className="text-accent-green">Pending</span>
        </h2>
        
        <div className="bg-card border border-border p-6 rounded-[2rem] mb-8 text-left text-accent-green/80">
          <div className="flex items-center justify-between mb-6">
            <span className="text-text-muted text-xs font-bold uppercase tracking-widest">Creds Verification</span>
